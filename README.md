...
![RustChat 技术架构图](docs/img/rustchat-technical-architecture.drawio.svg)

架构图源文件见：[docs/img/rustchat-technical-architecture.drawio.svg](docs/img/rustchat-technical-architecture.drawio.svg)
